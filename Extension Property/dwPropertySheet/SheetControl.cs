...
namespace Dotware.Components.PropertySheet
{
	...
	/// </summary>
	public class SheetControl : System.Windows.Forms.UserControl
	{
		...
		public bool PropPageDialogProc(IntPtr hwndDlg, uint msg, IntPtr wParam, IntPtr lParam)
		{
			...
			{		
				case WM.INITDIALOG:
					...
					APIWrapper.SetParent(this.Handle, this.hWin32Dlg);
					break;
				...
				case WM.NOTIFY: 
					...
					if(OnNotify(wParam, lParam, out pResult))
						APIWrapper.SetWindowLong(hWin32Dlg,(int) DWL.MSGRESULT,pResult);
		...
		protected virtual bool OnNotify(IntPtr wParam, IntPtr lParam, out int pResult) 
		{
			...
			if(nmhdr.hwndFrom!=hWin32Dlg && nmhdr.hwndFrom!=APIWrapper.GetParent(hWin32Dlg)) 
			{
				return false;
			}
		...
		private void InitializeComponent()
		{
			...
			this.SheetIcon = new System.Windows.Forms.NotifyIcon(this.components);
			// 
			// SheetIcon
			// 
			this.SheetIcon.Text = "Dotware";
			// 
			// SheetControl
			// 
